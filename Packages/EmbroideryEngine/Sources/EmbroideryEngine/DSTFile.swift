...
/// the delta between consecutive absolute positions, which interpolation
/// (US-105) guarantees to be encodable. Byte semantics are pinned by
/// ADR-012 and ADR-013.
public struct DSTFile: Hashable, Sendable {
    ...
    /// Convenience wrapper around `Data.write(to:)`; `data` is the
    /// primary, I/O-free API.
