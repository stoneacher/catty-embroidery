...
5b. A structurally valid version-1 payload whose script is `[loopEnd]` is **refused** with the unbalanced reason — the admission check. Its counterpart: a balanced payload decodes.
