...
3b. **Two edited windows**: A edits to Q and saves, B edits to R and saves, A backgrounds — the stored program is **R**. The case a "has edited" flag passes and the revision rule fails.
