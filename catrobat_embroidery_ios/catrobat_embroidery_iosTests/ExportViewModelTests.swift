...
/// Records what it was asked to write instead of touching the filesystem — Catty's
/// `EmbroideryServiceMock` shape, which is the one thing in that file worth porting.
@MainActor
private final class RecordingDSTFileWriter: DSTFileWriting {
...
@MainActor
private final class ThrowingDSTFileWriter: DSTFileWriting {
